...
const ZaloIcon = () => {
    return (
        <SvgIcon fill="#000000" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" width="100px" height="100px">
    ...
    return (
        <>
            ...
            <FabContainer>
                ...
                <FabLink url="https://zalo.me/0909049996" sx={{ backgroundColor: blue[800], color: 'white' }}>
                    <ZaloIcon />
                </FabLink>
            </FabContainer>
        </>
